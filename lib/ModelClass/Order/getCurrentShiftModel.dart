...
/// success : true
/// message : "success"
/// data : {"_id":"692529b1cce96462c4696340","name":"Mathan","email":"mathan@gmail.com","role":"OPERATOR","locationId":"6890d1700eb176a5bfc48b2a","isWaiter":false,"active":true,"createdAt":"2025-11-25T03:59:45.891Z","__v":1,"shift":"2","shiftData":["hi","hello"],"currentshift":"hi"}
...
class GetCurrentShiftModel {
  ...
  GetCurrentShiftModel.fromJson(dynamic json) {
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _currentshift = json['currentshift'];
  }
  String? _id;
  String? _name;
  String? _email;
  ...
  Data copyWith({
    ...
    String? currentshift,
      ...
      Data(
        ...
        currentshift: currentshift ?? _currentshift,
      );
  String? get id => _id;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['currentshift'] = _currentshift;
    return map;
  }
}
